...
public class SimpleMenu implements Menu {
    ...
    public boolean add(String parentName, String childName, ActionDelegate actionDelegate) {
        ...
        if (parentName == Menu.ROOT) {
            ...
            Optional<ItemInfo> possibleParent = findItem(parentName);
            if (possibleParent.isPresent()) {
                MenuItem parent = possibleParent.get().menuItem;
    ...
    @Override
    public Optional<MenuItemInfo> select(String name) {
        Optional<ItemInfo> possibleItem = findItem(name);
        MenuItemInfo menuItemInfo = null;
        if (possibleItem.isPresent()) {
            menuItemInfo = new MenuItemInfo(possibleItem.get().menuItem, possibleItem.get().number);
        }
