...
class PhoneNumber {
    ...
    /* все условия базового класса должны быть сохранены в подклассе */
...
class SomeOperatorSubscriber extends Subscriber {
    ...
    @Override
    public void setPhoneNumber(PhoneNumber phoneNumber) {
        this.phoneNumber = phoneNumber;  /* <= забыли сделать валидацию, т.е отсутствует условие базового класса */
    }
